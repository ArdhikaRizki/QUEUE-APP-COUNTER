      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-yellow-900 mt-1">
                  {isLoading ? "..." : metricsData?.data?.waiting || 0}
                </h3>
              </div>
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-blue-900 mt-1">
                  {isLoading ? "..." : metricsData?.data?.called || 0}
                </h3>
              </div>
          ...
          <Card className="!bg-green-50 !border-green-200">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-green-800 text-sm font-medium">Dilepaskan</p>
                <h3 className="text-3xl font-bold text-green-900 mt-1">
                  {isLoading ? "..." : metricsData?.data?.released || 0}
                </h3>
              </div>
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-red-900 mt-1">
                  {isLoading ? "..." : metricsData?.data?.skipped || 0}
                </h3>
              </div>
